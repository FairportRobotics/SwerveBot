...
public class SwerveDriveOld {

//	private static final Logger logger = LogManager.getLogger(SwerveDriveOld.class);
//
...
//
//	// swerve units
//	private static SwerveDriveUnitOld frontLeft, frontRight;
//	private static SwerveDriveUnitOld backLeft, backRight;
//
//	// swerve inputs
...
//			return;
//
//		frontLeft = new SwerveDriveUnitOld("frontLeft", RobotMap.FRONT_LEFT_DRIVE_TALON_ID,
//				RobotMap.FRONT_LEFT_ROTATE_TALON_ID, RobotMap.FRONT_LEFT_REVERSE_DRIVE,
//				RobotMap.FRONT_LEFT_REVERSE_TURN);
//
//		frontRight = new SwerveDriveUnitOld("frontRight", RobotMap.FRONT_RIGHT_DRIVE_TALON_ID,
//				RobotMap.FRONT_RIGHT_ROTATE_TALON_ID, RobotMap.FRONT_RIGHT_REVERSE_DRIVE,
//				RobotMap.FRONT_RIGHT_REVERSE_TURN);
//
//		backLeft = new SwerveDriveUnitOld("backLeft", RobotMap.BACK_LEFT_DRIVE_TALON_ID,
//				RobotMap.BACK_LEFT_ROTATE_TALON_ID, RobotMap.BACK_LEFT_REVERSE_DRIVE, RobotMap.BACK_LEFT_REVERSE_TURN);
//
//		backRight = new SwerveDriveUnitOld("backRight", RobotMap.BACK_RIGHT_DRIVE_TALON_ID,
...
//
//		SwerveDriveOld.updateDashboard();
//
//	}
//
